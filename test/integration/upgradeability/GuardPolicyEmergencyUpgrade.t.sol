...
contract GuardPolicyEmergencyUpgrade_Upgradeability_Integration_Test is BaseTest {
    ...
    function setUp() public override {
        ...
        // disable the current guard policy, simulating a temporary lock down of all the
        // rental safes
        ...
        admin.setGuardEmergencyUpgrade(address(migration));
    ...
    function test_Success_GuardPolicyEmergencyUpgrade() public {
