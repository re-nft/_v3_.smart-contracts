...
// Represents a stop policy which a rental safe owner can opt into
contract StopUpgrade is Stop {
...
contract StopPolicyMigration {
    ...
    function upgrade() public {
        ...
        ISafe(address(this)).enableModule(newPolicy);
